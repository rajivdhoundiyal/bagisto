@if (
    ...
    && (bool) core()->getConfigData('sales.payment_methods.omise_smart_button.active')
)
    @php
        $clientId = core()->getConfigData('sales.payment_methods.omise_smart_button.client_id');

        $acceptedCurrency = core()->getConfigData('sales.payment_methods.omise_smart_button.accepted_currencies');
    @endphp
    ...
    @pushOnce('scripts')
        ...
        <script
            ...
            id="v-omise-smart-button-template"
        >
            <div class="w-full paypal-button-container"></div>
        </script>

        <script type="module">
            app.component('v-omise-smart-button', {
                template: '#v-omise-smart-button-template',
