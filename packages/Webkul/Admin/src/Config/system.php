...
return [
    ...
    [
        ...
        'key'    => 'sales.payment_methods.omise_smart_button',
        'name'   => 'admin::app.configuration.index.sales.payment-methods.omise-smart-button',
        'info'   => 'admin::app.configuration.index.sales.payment-methods.omise-smart-button-info',
        'sort'   => 0,
        'fields' => [
            [
                'name'          => 'title',
                ...
                'name'          => 'public_key',
                'title'         => 'admin::app.configuration.index.sales.payment-methods.omise-public-key',
                'info'          => 'admin::app.configuration.index.sales.payment-methods.omise-public-key-info',
                'type'          => 'text',
                'depends'       => 'active:1',
                'validation'    => 'required_if:active,1',
                'channel_based' => true,
                ...
                'name'          => 'secret_key',
                'title'         => 'admin::app.configuration.index.sales.payment-methods.omise-secret-key',
                'info'          => 'admin::app.configuration.index.sales.payment-methods.omise-secret-key-info',
                'type'          => 'text',
                'depends'       => 'active:1',
                'validation'    => 'required_if:active,1',
                'channel_based' => true,
