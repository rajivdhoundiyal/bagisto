...
<head>
    ...
    >
    <meta http-equiv="Access-Control-Allow-Origin" content="**.omise.co" /> 

    <meta http-equiv="Content-Security-Policy" content="default-src 'self' data: gap: https://*.omise.co 'unsafe-eval'; style-src 'self' 'unsafe-inline'; media-src *;**script-src 'self' https://*.omise.co 'unsafe-inline' 'unsafe-eval';** ">
