...
<!-- 
                            <template v-else-if="cart.payment_method == 'omise_smart_button'">
                                
                                <form action="/api/checkout/onepage/orders" id="omise_standard_checkout" method="POST">
                                    <component is="script" src="https://cdn.omise.co/omise.js" 
                                    data-key="pkey_test_62ilojq0zt9viuuifd0" data-image="http://bit.ly/customer_image" 
                                    data-frame-label="Merchant site name" data-button-label="Proceed Payment" data-submit-label="Submit" 
                                    data-location="no" data-amount="10025" data-currency="thb" data-default-payment-method="credit_card"
                                    async></component>
                                </form>
                            </template> -->
